...
@Component({
  ...
  styleUrls: ['./inner-drill-down-resubmission.component.scss'],
})
export class InnerDrillDownResubmissionComponent implements OnInit {
...
@NgModule({
  ...
  providers: [],
  exports: [InnerDrillDownResubmissionComponent],
  declarations: [InnerDrillDownResubmissionComponent],
})
export class InnerDrillDownResubmissionModule {}
